...
public class UpdateManagerSettings extends LimeProps {
	...
	public static StringSetting OVERLAY_SLIDESHOW_JSON_URL = FACTORY.createStringSetting("OVERLAY_SLIDESHOW_JSON_URL", "http://academictorrents.com/client/searchoverlay.php");
}