 ...
 *
 */
public class AcademicTorrentsCrawledSearchResult extends AbstractCrawledSearchResult implements HttpSearchResult {
    ...
    private long calcSize(AcademicTorrentsFile file) {
        try {
