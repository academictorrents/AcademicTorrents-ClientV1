 ...
 *
 */
public class AcademicTorrentsSearchResult extends AbstractSearchResult implements CrawlableSearchResult {
    ...
    public AcademicTorrentsSearchResult(String domainName, AcademicTorrentsItem item) {
